...
type Provider = {
  key: string;
  color: string; // classe gradient per il monogramma
  mono: string;  // lettera/simbolo
  url?: string;  // pagina impostazioni del provider
};

const PROVIDERS: Provider[] = [
  { key: "gmail",   color: "from-red-400 to-orange-400",    mono: "G", url: "https://myaccount.google.com/apppasswords" },
  { key: "outlook", color: "from-sky-400 to-blue-500",      mono: "O", url: "https://account.microsoft.com/security" },
  { key: "yahoo",   color: "from-violet-500 to-purple-600", mono: "Y", url: "https://login.yahoo.com/account/security" },
  { key: "icloud",  color: "from-slate-400 to-slate-600",   mono: "", url: "https://appleid.apple.com" },
